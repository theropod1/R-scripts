ts.periods <- function(phylo=NULL,alpha=1,names=T,col.txt=NULL,border=NA,ylim=c(0,0.5),adj.txt=c(0.5,0.5),txt.y=mean,bw=F){
  ...
  periods <- data.frame(
    ...
    end = c(2.58, 23.03, 66, 145, 201.3, 252.17, 298.9, 358.9, 419.2, 443.8, 485.4, 541,635)
  )
...
periods$end<-tsconv(periods$end,phylo)
  ...
  colors <-paste0("#",c("F9F97F","FFE619","FD9A52","7FC64E","34B2C9","812B92","F04028","67A599","CB8C37","B3E1B6","009270","7FA056","FED96A"))
